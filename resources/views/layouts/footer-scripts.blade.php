...
<!-- Ionicons js -->
<script src="{{ asset('Dashboard_Assets/plugins/ionicons/ionicons.js')}}"></script>
<!-- Moment js -->
<script src="{{ asset('Dashboard_Assets/plugins/moment/moment.js')}}"></script>

<!-- Rating js-->
<script src="{{ asset('Dashboard_Assets/plugins/rating/jquery.rating-stars.js')}}"></script>
<script src="{{ asset('Dashboard_Assets/plugins/rating/jquery.barrating.js')}}"></script>

<!--Internal  Perfect-scrollbar js -->
<script src="{{ asset('Dashboard_Assets/plugins/perfect-scrollbar/perfect-scrollbar.min.js')}}"></script>
<script src="{{ asset('Dashboard_Assets/plugins/perfect-scrollbar/p-scroll.js')}}"></script>
<!--Internal Sparkline js -->
<script src="{{ asset('Dashboard_Assets/plugins/jquery-sparkline/jquery.sparkline.min.js')}}"></script>
<!-- Custom Scroll bar Js-->
<script src="{{ asset('Dashboard_Assets/plugins/mscrollbar/jquery.mCustomScrollbar.concat.min.js')}}"></script>
<!-- right-sidebar js -->
<script src="{{ asset('Dashboard_Assets/plugins/sidebar/sidebar-rtl.js')}}"></script>
